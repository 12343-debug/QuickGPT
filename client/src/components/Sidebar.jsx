...
const Sidebar = ({ isMenuOpen, setIsMenuOpen }) => {
  ...
  return (
    <div
      ...
      dark:from-[#242124]/30 dark:to-[#000000]/30 
    ...
    >
      ...
      <div
        ...
        className="flex items-center gap-3 p-3 mt-4 border border-gray-300 dark:border-white/15 rounded-mt cursor-pointer hover:scale-103 transition-all"
      >
        <img
      ...
      <div
        ...
        className="flex items-center gap-3 p-3 mt-4 border border-gray-300 dark:border-white/15 rounded-mt cursor-pointer hover:scale-105 transition-all"
      >
      ...
      {/*User Account*/}
      <div className="flex items-center gap-3 p-3 mt-4 border border-gray-300 dark:border-white/15 rounded-mt cursor-pointer group">
