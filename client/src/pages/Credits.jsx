      ...
      <h2 className='text-3xl font-semibold text-center mb-10 xl:mt-30 text-gray-800 dark:text-white'>
        ...
        <div className="flex flex-wrap justify-center gap-8">
          {plans.map((plan)=>(
            ...
            "bg-purple-50 dark:bg-purple-900" : "g-white dark:bg-transparent"}`}>
              ...
              'processing...'})} className='mt-6 bg-purple-600 hover:bg-purple-700 active:bg-purple-800 text-white 
